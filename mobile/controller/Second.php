...
// print_r($lists);
    ...
    private function getSeo($lx){
        if ($lx == "18334"){//住宅
            $seo['title'] = '住宅司法拍卖房源_法拍房__房屋拍卖信息_房拍网房源';
            $seo['keys']  = '住宅司法拍卖房源，住宅法拍房，住宅房屋拍卖信息';
            $seo['desc']  = '房拍网住宅房源栏目汇聚千余套低于市场价25%的优质住宅司法拍卖房产、法拍房源，丰富的房屋拍卖信息，可以便宜放心拍房，安心住新家。咨询电话400 677 0028';
        }elseif ($lx == '18333'){//商办
