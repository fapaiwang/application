        ...
        foreach($accc[$num] as $k=>$v){
            ...
            if(!empty($data)){
                ...
                foreach($data as $ks=>$vs){
                    ...
                    /*$image = \think\Image::open('../public/uploads/image/'.$v.'/'.$vs);
                    $image->water('../public/shuiyin2.png',\think\Image::WATER_CENTER,100)->save('../public/uploads/image/'.$v.'/'.$vs);*/
